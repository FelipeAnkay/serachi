...
<body>
  <div class="container">
    ...
    <p class="footer">
      ...
      Here are the Terms & Conditions of your booking ({{tycLink}}) 
      Once the deposit has been paid, your reservation will be confirmed.
...
<body>
  <div class="container">
    <h1>Hi {{customerName}},</h1>
    <p>Thank you for your time! We kindly ask you to complete the following forms before your experience begins:</p>
...
export const SEND_PROFILE = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Customer Profile Completion Required</title>
  <style>
    body {
      font-family: Arial, sans-serif;
      background-color: #f4f6f9;
...
<body>
  <div class="container">
    <h1>Hi {{customerName}},</h1>
    <p>Thank you for your time! We kindly ask you to complete your profile before your experience begins:</p>

    <h2>Profile to complete</h2>
    <table>
      <thead>
        <tr>
          <th>Name</th>
