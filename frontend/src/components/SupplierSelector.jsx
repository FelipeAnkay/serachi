    ...
    return (
        <div className="relative">
            <input
                ...
                className="w-full border px-2 py-1 rounded mb-2 bg-white"
                onFocus={() => setShowDropdown(true)}
                onBlur={() => setTimeout(() => setShowDropdown(false), 150)} // para permitir clic en dropdown
            />
            {showDropdown && filteredSuppliers.length > 0 && (
                <ul className="absolute z-10 w-full bg-white border rounded shadow max-h-48 overflow-y-auto text-slate-900">
            ...
            {showForm && (
                <div className="mt-2 space-y-2 bg-sky-50 p-2 rounded">
                    <input
                        type="text"
                        placeholder="Name"
                    ...
                    <div className="flex flex-col md:flex-row gap-2">
                        <button
                            ...
                            className="bg-[#118290] hover:bg-[#0d6c77] text-cyan-50 px-4 py-1 rounded"
                        >
                            Save Supplier
                        </button>
                        <button
                            ...
                            className="bg-red-400 text-slate-800 px-4 py-1 rounded ml-2"
                        >
                            Cancel
                        </button>
                    </div>
