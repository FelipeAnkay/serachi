...
export default function ConfirmedQuote() {
    ...
    const { createExperience, getExperienceList, updateExperience } = useExperienceServices();
        ...
        try {
            ...
            for (const product of quote.productList) {
                const servicePayload = {
                    name: product.productName + " - " + customer.name + " " + customer.lastName? customer.lastName : "",
            ...
            const expResp = await getExperienceList(storeId);
