...
const SetRooms = () => {
    ...
    if (loading) return <div className="text-slate-800 text-center mt-10">Loading Rooms...</div>;
            ...
            <div className="flex flex-col min-h-screen w-full bg-[#18394C] text-slate-800 px-4 py-6 sm:px-8 sm:py-10">
                ...
                <div className="flex justify-center mb-2">
                    <button
                        ...
                        className="text-sm text-slate-800 hover:text-blue-200 underline"
                    >
                            ...
                            >
                                ...
                                <div className="space-y-4 text-sm">
                                    ...
                                    <div className='mt-2 flex flex-row ml-2'>
                                        ...
                                        <select
                                            name="type"
                                            className="ml-2 w-full border border-gray-300 bg-white text-slate-900 rounded px-3 py-2"
                                            value={roomData.type || ''}
