...
const SetPartner = () => {
    ...
    if (loading) return <div className="text-slate-800 text-center mt-10">Loading partner...</div>;
            ...
            >
                ...
                <div className="flex flex-col items-center gap-3 mb-4">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-2 rounded bg-white text-slate-900 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                </div>
