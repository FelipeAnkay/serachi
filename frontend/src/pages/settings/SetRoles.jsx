...
const SetRoles = () => {
    ...
    if (loading) return <div className="text-slate-800 text-center mt-10">Loading Roles...</div>;
                                ...
                                <div className="space-y-4 text-sm">
                                    ...
                                    <div className='mt-2 flex flex-col ml-2'>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            {typeList.map((t) => (
                                                <label key={t.name} className="inline-flex items-center text-sm text-slate-800">
                                                    <input
                                                        type="checkbox"
                                                        className="mr-2"
